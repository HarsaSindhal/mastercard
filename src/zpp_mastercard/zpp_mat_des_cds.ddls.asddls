...
@EndUserText.label: 'CDS For Master Card Screen For Mat & MatDes'
define root view entity ZPP_MAT_DES_CDS as select from I_Product as a 
...
} where  ( a.Product like 'FF%' or a.Product like '0000000000077%' )  and c.Zpno is null 
