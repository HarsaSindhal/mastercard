...
@EndUserText.label: 'Cds For Materail Des FG'
define root view entity ZPP_MAT_DES_FG as select from I_Product as a 
...
} where   ( a.Product like 'FG%' or a.Product like '0000000000077%' ) 
         and c.Zpno is null // or a.Product like 'FG%' 
